        ...
        public class ExecuteCounterBatchCommand : TransactionOperationsMerger.MergedTransactionCommand
        {
            ...
            protected override int ExecuteCmd(DocumentsOperationContext context)
            {
                ...
                foreach (var kvp in _dictionary)
                {
                    ...
                    if (doc?.Data != null)
                    {
                        _database.DocumentsStorage.CountersStorage.UpdateDocumentCounters(context, doc, docId, countersToAdd, countersToRemove, NonPersistentDocumentFlags.ByCountersUpdate);
